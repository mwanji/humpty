...
public class PipelineTest {
  ...
  private Pipeline pipeline = new Pipeline(configuration, asList((Resolver) new ClasspathResolver()), Arrays.asList((PreProcessor) new CoffeeScriptPreProcessor()), Collections.<PostProcessor>emptyList());
